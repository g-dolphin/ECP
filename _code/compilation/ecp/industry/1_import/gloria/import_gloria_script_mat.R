...
tqm<-h5Read(file.path(fpe,paste0("QT_",timestep,".mat")),name="QT")

yqm<-h5Read(file.path(fpe,paste0("QY_",timestep,".mat")),name="QY")
...
rm(list=ls()[! ls() %in% c("wd","gversion","gloriawd","tmpmat")])
