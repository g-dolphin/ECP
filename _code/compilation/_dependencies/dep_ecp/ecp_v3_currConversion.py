...
def cur_conv(wcpd_all, gas, subnat_can_list, subnat_usa_list, subnat_chn_list, xRateFixed, baseYear=None):
    base_path = Path("/Users/gd/GitHub/ECP/_raw")
    dep_path = Path("/Users/gd/GitHub/ECP/_code/compilation/_dependencies/dep_ecp")
...
subnat_can_list = jurisdictions["subnationals"]["Canada"] 
subnat_chn_list = jurisdictions["subnationals"]["China"] 
subnat_usa_list = jurisdictions["subnationals"]["Japan"] 
