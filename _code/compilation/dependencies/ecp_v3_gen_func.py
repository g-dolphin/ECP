...
IEApre2015 = "/estimated-reported/national/IEA/iea_energy_combustion_emissions/detailed_figures/emissions_annual/2015Nom"
IEApost2015 = "/estimated-reported/national/IEA/iea_energy_combustion_emissions/detailed_figures/emissions_annual/Post2015Nom"

def concat_iea(indir=path_ghg+IEApost2015,
               outfile=path_ghg+"/estimated-reported/national/IEA/iea_energy_combustion_emissions/detailed_figures/emissions_allyears/iea_CO2em_ally.csv"):
    os.chdir(indir) #sets the current directory to 'indir'
...
def get_product_category(product_code):
    ...
    if(product_number == 1):
        return 'Total'
    elif(product_number >= 2 and product_number <= 20): #PRODUCT 20 is 'oil shale', which is aggregated into coal category, see IEA documentation
        return 'Coal/peat'
